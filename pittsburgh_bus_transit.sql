...
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Data/Pittsburgh SNAP Data 2010/Neighborhoods_with_SNAP_Data.csv'
...
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Python/neighborhoods_shp.csv'
...
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Data/Pittsburgh SNAP Data 2010/opendata-pghsnap-neighborhood-census-data_populationanddensity.csv'
...
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Data/Pittsburgh SNAP Data 2010/opendata-pghsnap-neighborhood-census-data_employment_educationandincome.csv'
...
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Data/Pittsburgh SNAP Data 2010/opendata-pghsnap-neighborhood-census-data_employment_transportation.csv'
...
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Data/Traffic Counts/8edd8a76-8607-4ed3-960f-dcae914fd937.csv'
    INTO TABLE sensors
    FIELDS TERMINATED BY ','
    LINES TERMINATED BY '\n'
    IGNORE 1 LINES
...
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Python/traffic_count_sensors_to_neighborhoods_clean.csv'
...
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Data/Port Authority Transit Stop Usage/busstopusagebyroute_clean.csv'
    IGNORE
    INTO TABLE busstop
    FIELDS TERMINATED BY ','
    LINES TERMINATED BY '\n'
...
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Data/Port Authority Monthly Average Ridership by Route/12bb84ed-397e-435c-8d1b-8ce543108698.csv'
    IGNORE
    INTO TABLE busroute
    FIELDS TERMINATED BY ','
    LINES TERMINATED BY '\n'
...
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Python/bus_stops_to_neighborhoods_clean.csv'
...
# Load data into neighborhood_busstop table from geopandas CONTAINS query results completed in python.
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Python/bus_stops_to_traffic_count_sensors_clean.csv'
...
# Load data into busroute table with desired data from monthly average ridership by route. Use "IGNORE" to populate just first instance of the route.
LOAD DATA
    LOCAL INFILE 'C:/Users/Chirag Sachdeva/Documents/Data M/Project/Final/Data/Port Authority Monthly On Time Performance by Route/00eb9600-69b5-4f11-b20a-8c8ddd8cfe7a.csv'
#     IGNORE
